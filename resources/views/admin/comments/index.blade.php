...
async function runBulkAiCheck() {
    ...
    if (!confirm('Hệ thống sẽ tự động quét AI tất cả bình luận có trạng thái "Chờ duyệt" để kiểm duyệt spam, bậy bạ, chia rẽ vùng miền và mất trật tự xã hội. Bạn có muốn tiếp tục?')) {
        return;
    }
